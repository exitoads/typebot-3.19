...
type Props = {
  content: ImageWithCaptionBubbleBlock["content"];
...
export const ImageWithCaptionBubble = (props: Props) => {
  ...
  const Image = (
    <img
      ...
      alt={props.content?.caption ?? "Bubble image"}
      class={cx(
    ...
    >
      <div class="flex w-full items-center">
        <div class="flex relative z-10 items-start typebot-host-bubble max-w-full">
          ...
          <figure
            class={cx(
              "z-10 cursor-pointer flex flex-col gap-1",
          ...
          >
            ...
            {!isTyping() && props.content?.caption && (
              <figcaption class="text-sm whitespace-pre-wrap">
