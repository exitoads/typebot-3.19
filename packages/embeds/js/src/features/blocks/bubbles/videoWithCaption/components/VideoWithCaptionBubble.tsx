...
type Props = {
  content: VideoWithCaptionBubbleBlock["content"];
...
export const VideoWithCaptionBubble = (props: Props) => {
            ...
            >
              ...
              >
                ...
                {!isTyping() && props.content?.caption && (
                  <p class="text-sm px-4 whitespace-pre-wrap">
